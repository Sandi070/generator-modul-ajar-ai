...
async function handleFormSubmit(e) {
    ...
    try {
        ...
        // Generate modul
        generatedModul = generateModulAjar(formData);
...
function generateModulAjar(data) {
    console.log('Generating modul ajar...');
    ...
    return {
        ...
        langkahPembelajaran: generateLangkahPembelajaran(data),
        asesmen: generateAsesmen(data),
        pengayaanRemedial: generatePengayaanRemedial(data)
    };
}
...
function generateLangkahPembelajaran(data) {
    const pendahuluan = [
    ...
    const kegiatan = generateKegiatanInti(data);
...
function generateKegiatanInti(data) {
...
function generateAsesmen(data) {
    // Try to use AI Generator for better questions
    let diagnostikSoal, sumatifSoal;
    
    console.log('🎯 Generating Asesmen...');
    console.log('📚 Mata Pelajaran:', data.mataPelajaran);
    console.log('📖 Materi:', data.materi);
    
    if (typeof AIGenerator !== 'undefined') {
        console.log('✅ AIGenerator is available, using intelligent generation');
        ...
        console.log('📝 Diagnostic questions:', diagnostikSoal);
        console.log('📝 Summative questions:', sumatifSoal);
    } else {
        console.warn('⚠️ AIGenerator not found, using fallback template');
...
function generatePengayaanRemedial(data) {
    console.log('🎓 Generating Pengayaan & Remedial...');
    
    let pengayaan, remedial;
    
    // Try to use AI Generator for specific content
    if (typeof AIGenerator !== 'undefined') {
        console.log('✅ Using AIGenerator for enrichment and remedial');
        ...
        console.warn('⚠️ AIGenerator not found, using fallback');
        // Fallback
        pengayaan = {
